...
from .models import CustomUser, Video, TestForm, Assignment, Submitted, Grade
...
class CustomUserAdmin(UserAdmin): 
    ...
    fieldsets = (
        (None, {'fields': ('username', 'first_name', 'last_name' ,'email', 'password', 'is_lecturer', 'is_staff', 'is_active')}),
    )
